...
#### 1. 介绍
本项目分为3部分，包括微信小程序、Web商户管理系统和Java服务器。此部分是Java服务端。其余两部分地址如下：

[微信小程序端项目地址](https://gitee.com/code_walker_l/eorder-mini)

[商户管理端项目地址](https://gitee.com/code_walker_l/eorder-admin)
